...
def en2kin_model_setup(src_lang='en', tgt_lang='rw'):
    global tokenizer
    global model
    global metric
...
def en2kin_dataset_preprocess(examples):
    global tokenizer
    global model
    global metric
    inputs = examples['en']
...
def en2kin_train():
    ...
    tokenized_training_dataset = training_dataset.map(en2kin_dataset_preprocess, batched=True)
    ...
    tokenized_validation_dataset = validation_dataset.map(en2kin_dataset_preprocess, batched=True)
