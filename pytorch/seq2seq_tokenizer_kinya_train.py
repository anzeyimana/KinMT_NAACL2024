...
if __name__ == '__main__':
    tokenizer_path = "tokenizers/sentencepiece/spm_kinya/kinya.spm.model"
    special_tokens = ["<s>", "<pad>", "</s>", "<unk>", "<cls>", "<sep>", "<mask>"]
    tk_tokenizer = SentencePieceBPETokenizer()

    text_file = open('kinmt/parallel_data_2022/txt/morpho_corpus_sentences_clean_2023-05-02_rw.txt', 'r', encoding='utf-8')
    ...
    # and save for later!
    tokenizer.save_pretrained("tokenizers/sentencepiece/kinyarwanda/")
