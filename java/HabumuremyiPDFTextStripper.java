 ...
 */
public class HabumuremyiPDFTextStripper extends LegacyPDFStreamEngine {
    ...
    private static final Log LOG = LogFactory.getLog(HabumuremyiPDFTextStripper.class);
    ...
    static {
        ...
        try {
            String className = HabumuremyiPDFTextStripper.class.getSimpleName().toLowerCase();
     ...
     */
    public HabumuremyiPDFTextStripper() throws IOException {
    }
